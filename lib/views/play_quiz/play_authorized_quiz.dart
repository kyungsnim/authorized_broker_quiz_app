...
class PlayQuiz extends StatefulWidget {
  ...
  PlayQuiz(quizId, inputQuizLength) {
    this.quizId = quizId;
...
class _PlayQuizState extends State<PlayQuiz> {
  ...
  void initState() {
    ...
    isLoading = true;
    databaseService.getQuizData(widget.quizId.trim()).then((val) {
      setState(() {
  ...
  QuestionModel getQuestionModelFromDataSnapshot(
    ...
    if (questionSnapshot.data["fromWho"] != null &&
      ...
      questionModel.fromWho = " 자료제공: ${questionSnapshot.data["fromWho"]}";
    } else {
...
//              ),
  ...
  Future<bool> _onPressedSubmitYn() {
    return showDialog(
          context: context,
          builder: (context) => AlertDialog(
      ...
      child: Scaffold(
        ...
        floatingActionButton: isViewAnswer
            ...
            : FloatingActionButton(
                ...
                onPressed: () async {
                  var submitYn = await _onPressedSubmitYn();
          ...
          isViewAnswer
              ? Container(
                  ...
                  child: RichText(
                    ...
                    children: <TextSpan>[
                      TextSpan(
                        text: widget.questionModel.hint == null || widget.questionModel.hint == "" || widget.questionModel.hint == "null"
                            ? ""
