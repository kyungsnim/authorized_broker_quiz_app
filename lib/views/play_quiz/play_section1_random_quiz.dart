...
int _correct1 = 0;
int _correct2 = 0;
int totalQuizLength = part1QuizLength + part2QuizLength;
...
class PlaySection1RandomQuiz extends StatefulWidget {
  @override
  _PlaySection1RandomQuizState createState() => _PlaySection1RandomQuizState();
}
...
class _PlaySection1RandomQuizState extends State<PlaySection1RandomQuiz> {
  ...
  String part1QuizId = "부동산학개론";
  String part2QuizId = "민법";
            ...
            itemBuilder: (context, index) {
              if (index < part1QuizLength) {
                ...
                return QuizPlayTile(
                    questionModel: getQuestionModelFromDataSnapshot(
                        questionSnapshot
                            .documents[part2IndexList[index - part1QuizLength]],
                        index),
                    index: index);
              }
            },
        ...
        isLoading
            ? Center(
                child: CircularProgressIndicator(
                  backgroundColor: Global.blueGrey,
                ),
              )
