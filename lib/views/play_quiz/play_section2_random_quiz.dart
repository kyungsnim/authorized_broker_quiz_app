...
int _correct2 = 0;
int _correct3 = 0;
int totalQuizLength = part1QuizLength + part2QuizLength + part3QuizLength;
int part1QuizLength = 40;
int part2QuizLength = 40;
int part3QuizLength = 40;
var part1IndexList;
var part2IndexList;
var part3IndexList;
...
class PlaySection2RandomQuiz extends StatefulWidget {
  @override
  _PlaySection2RandomQuizState createState() => _PlaySection2RandomQuizState();
}

class _PlaySection2RandomQuizState extends State<PlaySection2RandomQuiz> {
  ...
  String part1QuizId = "중개실무";
  String part2QuizId = "공법";
  String part3QuizId = "공시법세법";
  ...
  void initState() {
    ...
    if (!isViewAnswer) {
      ...
      databaseService.getRandomQuizData(part2QuizId).then((val) {
        setState(() {
          questionSnapshot2 = val;
        });
      });
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  resultRichText('중개사법\t', 30, _correct1, part1QuizLength, 25),
                  resultRichText('공법\t', 30, _correct2, part2QuizLength, 25),
                  resultRichText('공시법/세법\t', 30, _correct3, part3QuizLength, 25),
                ],
              ),
            ),
          ]),
...
//    if (!isViewAnswer && !isReset) { // 정답보기 후 다시풀기 기능 잠시 보류
    if (!isViewAnswer) {
      ...
      part2IndexList = new List<int>(part2QuizLength);
      ...
      for (int insertIndex = 0; insertIndex < part2QuizLength; insertIndex++) {
        part2IndexList[insertIndex] =
            randomIndex.nextInt(questionSnapshot2.documents.length);
        for (int searchIndex = 0; searchIndex < insertIndex; searchIndex++) {
          if (part2IndexList[searchIndex] == part2IndexList[insertIndex]) {
            insertIndex--;
            break;
          }
        }
              ...
              if (index < part1QuizLength) {
                ...
                return QuizPlayTile(
                    questionModel: getQuestionModelFromDataSnapshot(
                        ...
                        index),
                    index: index);
              } else if (index < part1QuizLength + part2QuizLength) {
                // 공법
                questionSnapshot = questionSnapshot2;
                return QuizPlayTile(
                    questionModel: getQuestionModelFromDataSnapshot(
                        questionSnapshot.documents[part2IndexList[index - part1QuizLength]],
                        index),
                    index: index);
              } else {
                // 공시법/세법
                ...
                return QuizPlayTile(
                    questionModel: getQuestionModelFromDataSnapshot(
                        questionSnapshot
                            .documents[part3IndexList[index - (part1QuizLength + part2QuizLength)]],
                        index),
                    index: index);
              }
            },
        ...
        floatingActionButton: isViewAnswer
            ...
            : FloatingActionButton(
                ...
                onPressed: () async {
                  ...
                  var submitYn = false; // 120문제 확인용
                  _correct = 0;
                  _correct1 = 0; // 결과화면 중개사법 정답개수
                  _correct2 = 0; // 결과화면 공법 정답개수
                  _correct3 = 0; // 결과화면 공시법/세법 정답개수

                  // 10문제 미만으로 풀고 제출하면 alert
                  if (cnt < 10) {
                    _underCntAlert();
                  } else {
                    // 최종 제출확인 팝업 (120개 다 풀었으면 db에 결과 반영, 다 안풀었으면 점수만 공개)
                    submitYn = await _onPressedSubmitYn(cnt);
                  }

                  // 120문제 다 푼게 맞다면 정답률에 반영하고 결과 보여주자
                    ...
                    try {
                      ...
                      for (int i = 0; i < correct.length; i++) {
                        ...
                        if (correct[i] == true) {
                          ...
                          if (i < part1QuizLength) {
                          ...
                          } else if (i < part1QuizLength + part2QuizLength) {
                            // db에 update할 map 작성하기 (part2)
                            _correct2++;
                            Map<String, int> resultMap = {
                              "correctCnt": questionSnapshot2
                                              .documents[part2IndexList[
                                                  i - part1QuizLength]]
                                              .data["correctCnt"] ==
                                          null ||
                                      questionSnapshot2
                            ...
                            databaseService.addResultData(
                                ...
                                questionSnapshot2
                                    .documents[
                                        part2IndexList[i - part1QuizLength]]
                                    .documentID);
                          } else {
                            ...
                            Map<String, int> resultMap = {
                              ...
                              i - (part1QuizLength + part2QuizLength)]]
                                  .data["correctCnt"] ==
                                  null ||
                                  questionSnapshot3
                                      .documents[part3IndexList[
                            ...
                            databaseService.addResultData(
                                ...
                                questionSnapshot3
                                    .documents[
                                part3IndexList[i - (part1QuizLength + part2QuizLength)]]
                                    .documentID);
                          }
                        } else {
